...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        $query = "INSERT INTO anggota (nama, kelas, alamat) VALUES ('{$nama}', '{$kelas}', '{$alamat}')";
        if (mysqli_query($koneksi, $query)) {
            header('Location: kelola_anggota.php?success=' . urlencode('Anggota berhasil ditambahkan.'));
            exit;
        }
...
<head>
    ...
    <title>Tambah Anggota - SIPUS</title>
    ...
    <main class="flex-1 p-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl border shadow-sm p-8">
                ...
                <!-- Header -->
                <div class="mb-6">
                    <h2 class="text-2xl font-semibold text-slate-800">Tambah Anggota</h2>
                    <p class="text-sm text-slate-500">Masukkan data anggota baru</p>
                </div>
                ...
                <!-- Form -->
                <form action="anggota_tambah.php" method="post" class="space-y-5">
